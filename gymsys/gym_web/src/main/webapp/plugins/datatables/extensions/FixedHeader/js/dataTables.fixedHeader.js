...
FixedHeader.prototype = {
	...
	fnInit: function ( oDtSettings, oInit )
	{
		...
		/* Record the userInfo definable settings */
	 ...
	 * Purpose:  Take the userInfo's settings and copy them to our local store
	 * Returns:  -
	 * Inputs:   object:s - the local settings object
	 *           object:oInit - the userInfo's settings object
	 */
