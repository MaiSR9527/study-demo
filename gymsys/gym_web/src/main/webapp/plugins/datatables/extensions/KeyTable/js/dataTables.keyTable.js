...
KeyTable = function ( oInit )
{
	...
	/*
	 * Function: _fnClick
	 * Purpose:  Focus on the element that has been clicked on by the userInfo
	 * Returns:  -
	...
	function _fnKey ( e )
	{
		/* If userInfo or system has blocked KeyTable from doing anything, just ignore this event */
