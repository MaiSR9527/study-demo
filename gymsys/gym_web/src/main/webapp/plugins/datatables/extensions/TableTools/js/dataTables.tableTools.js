...
ZeroClipboard_TableTools.Client.prototype = {
	...
	handlers: null, // userInfo event handlers
	sized: false,
	...
	addEventListener: function(eventName, func) {
		// add userInfo event listener for event
	...
	receiveEvent: function(eventName, args) {
		...
		} // userInfo defined handler for event
	}
...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		...
		/**
		 * Store of the userInfo input customisation object
		 *  @property custom
		 *  @type	 object
		 *  @default  {}
		 */
	...
	this.dom = {
		...
		"print": {
			...
			/**
			 * The information display saying telling the userInfo about the print display
			 *  @property message
			 *  @type	 node
			 *  @default  null
			 */
...
TableTools.prototype = {
	 ...
	 *    userInfo to let them know what the print view is.
	...
	/**
	 * Show a message to the end userInfo which is nicely styled
	 *  @param {string} message The HTML string to show to the userInfo
	...
	/**
	 * Take the userInfo defined settings and the default settings and combine them.
	...
	"_fnCustomiseSettings": function ( oOpts )
	{
		...
		/* Clone the defaults and then the userInfo options */
		...
		// Backwards compatibility - allow the userInfo to specify a custom class in the initialiser
	...
	/**
	 * Take the userInfo input arrays and expand them to be fully defined, and then add them to a given
	 * DOM element
	 *  @method  _fnButtonDefinations
	 *  @param {array} buttonSet Set of userInfo defined buttons
	...
	"_fnCollectionShow": function ( nButton, oConfig )
	{
		...
		/* This results in a very small delay for the end userInfo but it allows the animation to be
		...
		if ( this.s.master )
		{
			...
			if ( this.s.select.type === 'os' ) {
				...
				$(dt.nTBody).on( 'mouseup.DTTT_Select', 'tr', function(e) {
					$(dt.nTBody).css( '-moz-userInfo-select', '' );
				} );
			}
	...
	"_fnPrintStart": function ( oConfig )
	{
	  ...
	  var oSetDT = this.s.dt;
		...
		/* Show information message to let the userInfo know what is happening */
		if ( oConfig.sInfo !== "" )
		{
