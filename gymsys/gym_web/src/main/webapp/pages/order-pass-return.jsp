...
<div class="wrapper">
    ...
    <div class="content-wrapper" id="el">
        ...
        <!-- 正文区域 -->
        <form action="${pageContext.request.contextPath}/order/updateEquipStatus.do" method="post">
            <section class="content"> <!--订单信息-->
                <div class="panel panel-default">
                    ...
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" readonly="readonly" value="${order.days}" placeholder="借取天数" name="days" >
                        </div>
                        ...
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" readonly="readonly" value="${order.num}" placeholder="借取数量" name="num" >
                        </div>
                        ...
                        <div class="col-md-2 title">器材状态</div>
                        <div class="col-md-4 data">
